                    ...
                    <div className="col-12 col-md-9">
                      <Form onSubmit={this.handleSubmit}>
                          <FormGroup row>
                            ...
                            value={this.state.firstname}  onBlur={this.handleBlur('firstname')} valid={errors.firstname === ''}
                          ...
                          <FormGroup row>
                            ...
                            <Input onChange={this.handleInputChange} type="text" id="lastname" name="lastname" placeholder="Last Name"
                             value={this.state.lastname}  onBlur={this.handleBlur('lastname')}    valid={errors.lastname === ''}
                          ...
                          <FormGroup row>
                            ...
                            placeholder="Tel. Number" value={this.state.telnum}  onBlur={this.handleBlur('telnum')}
                          ...
                          <FormGroup row>
                            ...
                            placeholder="E-mail" value={this.state.email}  onBlur={this.handleBlur('email')}
